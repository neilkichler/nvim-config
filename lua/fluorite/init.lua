local Color = require("fluorite.utils").Color
local palette = require("fluorite.palette")
...
Color.new("fluorite_bg", palette.fluorite_bg)
...
-- applying highlights
require("fluorite.theme")
require("fluorite.syntax")
require("fluorite.plugins")
require("fluorite.languages")
